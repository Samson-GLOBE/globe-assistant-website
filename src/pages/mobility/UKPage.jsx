...
import { ArrowRight, Gavel, Home, ExternalLink } from 'lucide-react';

export default function UKPage() {
  const sections = [
    {
      title: 'Visa Guide',
      desc: 'Standard Visitor Visa requirements for your Bangor semester.',
      icon: <Gavel size={32} />,
      path: '/mobility/uk/visa-guide',
    },
    {
      title: 'Housing',
      desc: 'Finding student accommodation in Bangor, Wales.',
      icon: <Home size={32} />,
      path: '/mobility/uk/housing',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-warmCream/30">
      <PageHeader 
        ...
        subtitle="Semester 2 — Bangor University, Wales"
      />
          ...
          <div className="bg-textPrimary text-white rounded-3xl p-10 md:p-14 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-3xl font-serif mb-4 italic font-bold">Bangor University Support</h3>
                <p className="text-sand/70 mb-8 max-w-xl">
                  Bangor University provides dedicated support for international students. 
                  Remember to contact the International Office as soon as you receive your acceptance.
                </p>
                <a 
                  href="https://www.bangor.ac.uk/international" 
                  target="_blank"
                ...
                >
                  Bangor International <ExternalLink size={16} />
                </a>
              </div>
            </div>
          </div>
