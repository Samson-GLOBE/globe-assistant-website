...
import { ArrowRight, ShieldCheck, MapPin, ExternalLink } from 'lucide-react';

export default function MexicoPage() {
  const sections = [
    {
      title: 'Visa Information',
      desc: 'Requirements for non-remunerated visitor status.',
      icon: <ShieldCheck size={32} />,
      path: '/mobility/mexico/visa',
    },
    {
      title: 'Summer School',
      desc: 'Getting ready for fieldwork in Tlaxcala.',
      icon: <MapPin size={32} />,
      path: '/mobility/mexico/summer-school',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-warmCream/30">
      <PageHeader 
        title="🇲🇽 Mexico" 
        subtitle="Summer School — Universidad Autónoma de Tlaxcala (UATx)"
      />
          ...
          <div className="bg-textPrimary text-white rounded-3xl p-10 md:p-14 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-3xl font-serif mb-4 italic font-bold">UATx Tlaxcala Support</h3>
                <p className="text-sand/70 mb-8 max-w-xl">
                  The Universidad Autónoma de Tlaxcala welcomes GLOBE students for a highly immersive biodiversity experience. 
                  Reach out to the local coordinators for group travel and health advice.
                </p>
                <a 
                  href="https://www.uatx.mx" 
                  target="_blank"
                ...
                >
                  UATx Website <ExternalLink size={16} />
                </a>
              </div>
            </div>
          </div>
